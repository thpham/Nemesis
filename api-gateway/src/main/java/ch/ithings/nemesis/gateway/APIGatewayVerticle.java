package ch.ithings.nemesis.gateway;

import ch.ithings.nemesis.account.Account;
import ch.ithings.nemesis.account.AccountService;
import ch.ithings.nemesis.common.RestAPIVerticle;
import ch.ithings.nemesis.common.functional.Functional;
...
public class APIGatewayVerticle extends RestAPIVerticle {
  ...
  public void start(Future<Void> future) throws Exception {
    ...
    HttpServerOptions httpServerOptions = new HttpServerOptions()
      .setLogActivity(true)
      .setUseAlpn(true)
      .setOpenSslEngineOptions(new OpenSSLEngineOptions().setSessionCacheEnabled(true))
      .setSsl(true)
