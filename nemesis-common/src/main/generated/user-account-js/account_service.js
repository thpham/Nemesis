...
/** @module user-account-js/account_service */
var utils = require('vertx-js/util/utils');
var Vertx = require('vertx-js/vertx');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JAccountService = Java.type('ch.ithings.nemesis.account.AccountService');
var Account = Java.type('ch.ithings.nemesis.account.Account');
...
var AccountService = function(j_val) {
  ...
  this.addAccount = function(account, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_accountService["addAccount(ch.ithings.nemesis.account.Account,io.vertx.core.Handler)"](account != null ? new Account(new JsonObject(Java.asJSONCompatible(account))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.updateAccount = function(account, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_accountService["updateAccount(ch.ithings.nemesis.account.Account,io.vertx.core.Handler)"](account != null ? new Account(new JsonObject(Java.asJSONCompatible(account))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnDataObject(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
...
AccountService._jclass = utils.getJavaClass("ch.ithings.nemesis.account.AccountService");
...
AccountService.createProxy = function(vertx, address) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return utils.convReturnVertxGen(AccountService, JAccountService["createProxy(io.vertx.core.Vertx,java.lang.String)"](vertx._jdel, address));
  } else throw new TypeError('function invoked with invalid arguments');
};
