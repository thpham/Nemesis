...
/** @module cache-counter-js/counter_service */
var utils = require('vertx-js/util/utils');
var Vertx = require('vertx-js/vertx');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JCounterService = Java.type('ch.ithings.nemesis.cache.CounterService');
...
CounterService._jclass = utils.getJavaClass("ch.ithings.nemesis.cache.CounterService");
...
/**
 ...
 @memberof module:cache-counter-js/counter_service
 @param vertx {Vertx} 
 @param address {string} 
 @return {CounterService}
 */
CounterService.createProxy = function(vertx, address) {
  var __args = arguments;
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return utils.convReturnVertxGen(CounterService, JCounterService["createProxy(io.vertx.core.Vertx,java.lang.String)"](vertx._jdel, address));
  } else throw new TypeError('function invoked with invalid arguments');
};
