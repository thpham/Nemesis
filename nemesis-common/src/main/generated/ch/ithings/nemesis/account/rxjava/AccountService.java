...
package ch.ithings.nemesis.account.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link ch.ithings.nemesis.account.AccountService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(ch.ithings.nemesis.account.AccountService.class)
public class AccountService {

  public static final io.vertx.lang.rxjava.TypeArg<AccountService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new AccountService((ch.ithings.nemesis.account.AccountService) obj),
    AccountService::getDelegate
  );

  private final ch.ithings.nemesis.account.AccountService delegate;
  
  public AccountService(ch.ithings.nemesis.account.AccountService delegate) {
    this.delegate = delegate;
  }

  public ch.ithings.nemesis.account.AccountService getDelegate() {
    return delegate;
  }
  ...
  public static AccountService newInstance(ch.ithings.nemesis.account.AccountService arg) {
