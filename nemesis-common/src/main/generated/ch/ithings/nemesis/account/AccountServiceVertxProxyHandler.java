  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "addAccount": {
          service.addAccount(json.getJsonObject("account") == null ? null : new ch.ithings.nemesis.account.Account(json.getJsonObject("account")), createHandler(msg));
          break;
        }
        ...
        case "updateAccount": {
          service.updateAccount(json.getJsonObject("account") == null ? null : new ch.ithings.nemesis.account.Account(json.getJsonObject("account")), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
