...
package ch.ithings.nemesis.cache.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link ch.ithings.nemesis.cache.CounterService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(ch.ithings.nemesis.cache.CounterService.class)
public class CounterService {

  public static final io.vertx.lang.rxjava.TypeArg<CounterService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new CounterService((ch.ithings.nemesis.cache.CounterService) obj),
    CounterService::getDelegate
  );

  private final ch.ithings.nemesis.cache.CounterService delegate;
  
  public CounterService(ch.ithings.nemesis.cache.CounterService delegate) {
    this.delegate = delegate;
  }

  public ch.ithings.nemesis.cache.CounterService getDelegate() {
    return delegate;
  }
  ...
  public static CounterService newInstance(ch.ithings.nemesis.cache.CounterService arg) {
