...
import ch.ithings.nemesis.account.AccountServiceVertxEBProxy;
import ch.ithings.nemesis.account.AccountServiceVertxProxyHandler;
 ...
 * @author
 */
@VertxGen // Generate service proxies
@ProxyGen // Generate the clients
