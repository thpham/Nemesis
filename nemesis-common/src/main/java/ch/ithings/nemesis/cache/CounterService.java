...
// import ...VertxProxyHandler to force it to be compiled and attached to the jar.
import ch.ithings.nemesis.cache.CounterServiceVertxEBProxy;
import ch.ithings.nemesis.cache.CounterServiceVertxProxyHandler;
...
public interface CounterService {
   ...
   * @param key           counter key
    ...
    static CounterService createProxy(Vertx vertx, String address) {
        return new CounterServiceVertxEBProxy(vertx, address);
    }
